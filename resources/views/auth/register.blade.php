                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                <div class="col-md-12">
                                    <input id="email" placeholder="correo" type="email" class="form-control" name="email" value="{{ old('email') }}" required>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input id="password-confirm" placeholder="confirmacion de contraseña" type="password" class="form-control" name="password_confirmation" required>
                                </div>
                            </div>
